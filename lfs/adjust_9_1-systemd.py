# adjust_9.1-systemd.py - adjusting for a specific version of the book

"""Configuration data to adjust the build process for version 9.1-systemd.
...
/tools/bin/bash --login +h /pkg_lfs/script_03.sh"""
    ...
    # Glibc-2.31
    '6.09': [
        (13, 'ignore'),  # this is an alternative
        (16, 'ignore'),  # we set the time zone in one of our variables
    ],
    ...
    # Util-linux-2.35.1
    '6.76': [(4, 'ignore')],  # Running the test suite as root can be harmful

    # Stripping Again
    '6.79': 'ignore',  # snippet #1 does an 'exec', need more study here
...
EOF"""
    ...
    '9.03': [
        ...
        (0.5, 'pop'),  # end of script_05.sh, pushed in 6.80_1.5
